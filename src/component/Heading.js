    ...
    return(
        <div className="bg-[#ff5200] font-serif">
                ...
                <div className="flex justify-between container mx-auto py-8">
                   <img className="w-40 h-12" src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/portal/static-assets/images/swiggy_logo_white.png"></img>
                    <div className=" text-white text-base font-bold flex gap-15 items-center">
                        ...
                        <a className="border border-white-1 py-3 px-4 rounded-2xl">Get the App</a>
                        <a className="border border-black py-3 px-4 bg-black font-bold rounded-2xl">Sign in</a>
                    </div>
                ...
                <div className="relative pt-16 pb-8">
                    ...
                    <div className="flex   max-w-[65%] container mx-auto gap-5 mt-10">
                        <input className="w-75 border text-xl rounded-2xl border-white bg-white px-6 py-4" type="text" placeholder="Enter your delivery location"></input>
                        <input className="w-125 border text-xl rounded-2xl border-white bg-white px-6 py-4"type="text" placeholder="Search for restaurants,items and more"></input>
                    </div>
